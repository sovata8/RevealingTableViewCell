#
#  Be sure to run `pod spec lint RevealingTableViewCell.podspec' to ensure this is a
...
NOTE: At this early stage, this is an experimental project. Things might change quickly, with no backwards compatibility. Using this in production environments is not a good idea.
  ...
  s.homepage     = "https://github.com/sovata8/RevealingTableViewCell"
  ...
  s.author             = { "Nikolay Suvandzhiev" => "mail@nikolaysuvandzhiev.com" }
  # Or just: s.author    = "sovata"
  # s.authors            = { "sovata" => "nikolay.suvandzhiev@gmail.com" }
  # s.social_media_url   = "http://twitter.com/sovata"
  ...
  s.source       = { :git => "https://github.com/sovata8/RevealingTableViewCell.git", :tag => "v0.0.5-alpha" }
  ...
  s.source_files  = "RevealingTableViewCell", "RevealingTableViewCell/**/*.{h,m}"
